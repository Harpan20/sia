                ...
                <div class="col-12 my-3">
                  <form action="<?= base_url($action) ?>" method="post">
                      <div class="form-group">
                        <label for="no_ref">Kode Akun</label>
                        <p><?= form_error('no_reff') ?></p>
                        <input type="text" name="no_reff" class="form-control mb-3" id="no_reff" value="<?= $data->no_reff ?>">
                        <input type="hidden" name="no_reff_old" class="form-control mb-3" id="no_reff_old" value="<?= $data->no_reff ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="d_or_k">Saldo Normal</label>
                        <p><?= form_error('d_or_k') ?></p>
                        <select class="form-control mb-3" id="d_or_k" name="d_or_k">
                          <option value="D" <?php $data->d_or_k=="D"? " selected" : "" ?>>Debit</option>
                          <option value="K" <?php $data->d_or_k=="K"? " selected" : "" ?>>Kredit</option>
                        </select>
                       </div>
